...
5. Jeśli błąd był w klasie „poziom bez wyjścia” — pamiętaj: **nie zamykaj dziury**, użyj `^`/`V` na dnie lub spłyć do 2 kafli.
6. Usuń tymczasowe skrypty/zrzuty. Podsumuj: przyczyna (1–2 zdania), zmiana (plik → funkcja), dowód (co pokazał test przed/po).
